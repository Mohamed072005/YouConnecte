            ...
            <div class="col-md-3">
                <aside class="p-4 aside">
                    <ul class="list-group">
                        ...
                        <li class="text-ligh"><a href="{{ route('to.logout') }}" class="h5 text-dark"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="Logout-1--Streamline-Ultimate.svg" height="28" width="28">
